...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APowerUp_Statics::NewProp_FPSProjectile_MetaData[] = {
		{ "Category", "PowerUp" },
		{ "ModuleRelativePath", "PowerUp.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APowerUp_Statics::NewProp_FPSProjectile = { "FPSProjectile", nullptr, (EPropertyFlags)0x0020080000000004, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APowerUp, FPSProjectile), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APowerUp_Statics::NewProp_FPSProjectile_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APowerUp_Statics::NewProp_FPSProjectile_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APowerUp_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APowerUp_Statics::NewProp_FPSProjectile,
	};
	...
	IMPLEMENT_CLASS(APowerUp, 2018934819);
