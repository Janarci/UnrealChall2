...
#include "UnrealChallenge/PowerUp.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	UNREALCHALLENGE_API UClass* Z_Construct_UClass_APowerUp_NoRegister();
	UNREALCHALLENGE_API UClass* Z_Construct_UClass_APowerUp();
...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_PowerUpType;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_APowerUp_Statics::NewProp_PowerUpType = { "PowerUpType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APowerUp, PowerUpType), METADATA_PARAMS(Z_Construct_UClass_APowerUp_Statics::NewProp_PowerUpType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APowerUp_Statics::NewProp_PowerUpType_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APowerUp_Statics::NewProp_MyMesh_MetaData[] = {
		{ "Category", "PowerUp" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "PowerUp.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APowerUp_Statics::NewProp_MyMesh = { "MyMesh", nullptr, (EPropertyFlags)0x00100000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APowerUp, MyMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APowerUp_Statics::NewProp_MyMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APowerUp_Statics::NewProp_MyMesh_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APowerUp_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APowerUp_Statics::NewProp_MyMesh,
	};
	...
	IMPLEMENT_CLASS(APowerUp, 953615359);
	template<> UNREALCHALLENGE_API UClass* StaticClass<APowerUp>()
	{
		return APowerUp::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APowerUp(Z_Construct_UClass_APowerUp, &APowerUp::StaticClass, TEXT("/Script/UnrealChallenge"), TEXT("APowerUp"), false, nullptr, nullptr, nullptr);
